...
import es.framework.db.NoteDataSource;
import es.framework.entities.Note;
import es.framework.ui.adapters.NoteListAdapter;
import es.framework.ui.adapters.OnStartDragListener;
import es.framework.ui.adapters.SimpleItemTouchHelperCallback;
